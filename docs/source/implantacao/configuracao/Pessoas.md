...
1. Para edição de uma Pessoa no Super.BR, o usuário deverá acessar o Menu Pessoa, existente na visão Administrador, e clicar no botão “Editar” <img src="../../_static/images/Botão lápis (editar).png" style=" zoom: 50%"/> , localizado na parte direita do registro da pessoa; 
...
<img src="../../_static/images/Pe'/ssoas - Tela com a Lista de Campos _Documentos.png"/>
...
**País:** Campo destinado ao registro do País do Município cadastrado.  
